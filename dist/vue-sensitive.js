  ...
  install: function install(Vue) {
    ...
    Vue.filter('sensitive', function () {
      ...
      if (val) {
        ...
        // end  保留的后几位
        // char  替换的字符串
        var hideStr = function hideStr(str, start, end, char) {
          ...
          case 'email':
            {
              ...
              if (val.indexOf('@') > 0) {
                ...
                var result = '';
                if (str[0].length > 3) {
                  for (var _i2 = 0; _i2 < str[0].length - 3; _i2++) {
                    result += '*';
                  }
                }
...
var vueSensitive_1 = vueSensitive.install;

exports['default'] = vueSensitive;
exports.install = vueSensitive_1;
